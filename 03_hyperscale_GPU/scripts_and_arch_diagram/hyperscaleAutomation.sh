...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/gb200NodeGPUCount.txt
sleep 10
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/b100NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/b200NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/h100NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/h200NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/a30NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/a100NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/v100NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/l4NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/t4NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/mi355xNodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/mi325xNodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/mi300aNodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/jaguarShoresNodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/falconShoresNodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/crescentIslandNodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/max1550NodeGPUCount.txt
sleep 10
kubectl delete clusterrole compute-domain-controller-role fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete clusterrolebinding compute-domain-controller-role-binding fake-kwok-gpu-device-plugin fake-device-plugin topology-server mig-faker fake-status-exporter fake-status-updater --ignore-not-found
kubectl delete deviceclass compute-domain-default-channel.nvidia.com compute-domain-default-channel.nvidia.com --ignore-not-found
...
kubectl get nodes -o custom-columns='NAME:.metadata.name,GPU_COUNT:.status.allocatable.nvidia\.com/gpu,GPU_TYPE:.metadata.labels.gpu' >> hyperscale_output_nodes/b580NodeGPUCount.txt
...
kubectl wait --for=condition=Ready pods --all -n l4 --timeout=120s >> l4.txt
...
echo "Script completed - The cluster and all nodes/deployments configured and available."
